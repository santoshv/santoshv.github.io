...
Write a program that takes as input a finite list of binary strings and outputs a program that takes a binary string as input and outputs ``YES" if it is a string on the list and ``NO" otherwise. 
